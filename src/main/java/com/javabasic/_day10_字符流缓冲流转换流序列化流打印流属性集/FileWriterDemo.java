...
public class FileWriterDemo {
    public static void main(String[] args) throws Exception {
        ...
        //Writer fw = new FileWriter("src\\main\\java\\com\\javabasic\\_day10_字符流缓冲流转换流序列化流打印流属性集\\text01.txt");  // 覆盖数据管道
        Writer fw = new FileWriter("src\\main\\java\\com\\javabasic\\_day10_字符流缓冲流转换流序列化流打印流属性集\\text01.txt", true); // 追加数据管道
